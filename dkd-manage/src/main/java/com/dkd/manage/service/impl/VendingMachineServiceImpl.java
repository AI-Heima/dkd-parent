...
public class VendingMachineServiceImpl implements IVendingMachineService 
{
    ...
    public int insertVendingMachine(VendingMachine vendingMachine)
    {
        ...
        vendingMachine.setCreateTime(DateUtils.getNowDate()); // 更新时间
        // 1-5 保存
     ...
     */
    @Override
    public VendingMachine selectVendingMachingeByInnerCode(String innerCode) {
        return vendingMachineMapper.selectVendingMachingeByInnerCode(innerCode);
    }
}
