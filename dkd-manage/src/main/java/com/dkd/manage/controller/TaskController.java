...
public class TaskController extends BaseController
{
    ...
    @PreAuthorize("@ss.hasPermi('manage:task:query')")
    @GetMapping("/assignor/{assignorId}")
    public AjaxResult getAssignorById(@PathVariable("assignorId") Long assignorId) {
        return success(taskMapper.getAssignorById(assignorId));
    }
}
